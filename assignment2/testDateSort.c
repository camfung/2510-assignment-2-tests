...
int testSort(char* input[], char* expected[], int numLines, int testNum) {
    Node** inputArray = (Node**) malloc(sizeof(Node*) * numLines);

    makeArray(input, numLines, inputArray);

    quicksort(inputArray, 0, numLines - 1);

    for (int i = 0; i < numLines; i++) {
        if (strcmp(inputArray[i]->line, expected[i]) != 0) {
            printf("failed test %d\n", testNum);
            printf("=====output:=====\n");
            printArray(inputArray, numLines);
            printf("=====expected:=====\n");
            for (int j = 0; j < numLines; j++) {
                printf("%s\n", expected[j]);
            }
            freeArray(inputArray, numLines);
            return 0;
        }
    }
...
int main(int argc, char** argv) {
    ...
    // baseline test
    char* lines[] = {
        "John Smith Jan-1-2000 4.3 D",
    };
    char* lines1[] = {
        "John Smith Jan-1-2000 4.3 D",
    };
    testSort(lines, lines1, 1, 1);

// test 2
// prints the first 2 from 3[] as last 2 in 2[]
    // char* lines2[] = {
    //     "John Smith Jan-1-2000 4.3 D",
    // };
    // char* lines3[] = {
    //    "John add Jan-1-2001 4.3 D",
    //    "John sub Jan-1-2002 4.3 D", 
    //    "John Smith Jan-1-2000 4.3 D",
    // };
    // testSort(lines2, lines3, 3, 2);
    ...
    char* lines4[] = {
        "John Smith Jan-1-2000 4.3 D",
       "J Smith Jan-1-2000 4.3 D",
       "Jo Smith Jan-1-2000 4.3 D",
       "Joh Smith Jan-1-2000 4.3 D",
    ...
    testSort(lines4, lines5, 4, 3);

    // test 4
    // different first names

    char* lines6[] = {
        "Eferan Smith Jan-1-2000 4.3 D",
        "Cameron Smith Jan-1-2000 4.3 D",
        "Hillary Smith Jan-1-2000 4.3 D", 
        "Alex Smith Jan-1-2000 4.3 D",
    ...
    testSort(lines6, lines7, 4, 4);

    // test 5
        char* lines6[] = {
        "Alex Smit Jan-1-2000 4.3 D",
        "Alex Smith Jan-1-2000 4.3 D",
        "Alex S Jan-1-2000 4.3 D",
        "Alex Smi Jan-1-2000 4.3 D",
        "Alex Sm Jan-1-2000 4.3 D",
    };
    char* lines7[] = {
        "Alex S Jan-1-2000 4.3 D",
        "Alex Sm Jan-1-2000 4.3 D",
